...
out_prefix = "outputs/sim_WMAP_inhomog/chain_03/"

#                   id     preconditioners                      lmax    nside       im        em      tr      cache
chain_descr  =  [ [  4,    ["diag_cl"],                           64,     32,        3,      0.0,    tr_cg,   qcinv.cd_solve.cache_mem()],
                  [  3,    ["split(stage(4),  64, diag_cl)"],    128,     64,        3,      0.0,    tr_cg,   qcinv.cd_solve.cache_mem()],
